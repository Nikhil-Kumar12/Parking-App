...
export default function PopupInfo({
  ...
  return (
    // <div className="fixed bg-[#00000080] w-full h-[100vh] top-0 left-0">
    //   <div className="flex flex-col justify-center items-center relative w-[300px] max-w-[600px] mx-auto mt-32 bg-white rounded p-5 border border-solid border-[#999] overflow-auto">
    ...
    ReactDOM.createPortal(
      <React.Fragment>
        <div
          ...
          onClick={handleClose}
        ></div>
        <div className="w-[400px] md:h-[400px] xl:h-[400px] rounded-[8px] bg-primary-white flex flex-col justify-between px-6 py-4 fixed top-[50%] left-[50%] -translate-y-1/2 -translate-x-1/2 z-20 ">
          <h1 className="font-medium mb-2 w-full text-center">
            Create a Group
          </h1>
